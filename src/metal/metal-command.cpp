...
void CommandRecorder::cmdSetRenderState(const commands::SetRenderState& cmd)
{
    ...
    if (updateBindings)
    {
        ...
        encoder->setVertexBuffers(m_bindingData->buffers, nullptr, NS::Range(0, m_bindingData->bufferCount));
        encoder->setFragmentBuffers(m_bindingData->buffers, nullptr, NS::Range(0, m_bindingData->bufferCount));
