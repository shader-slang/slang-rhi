...
void CommandRecorder::cmdClearTextureDepthStencil(const commands::ClearTextureDepthStencil& cmd)
{
    ...
    NS::SharedPtr<MTL::RenderPassDescriptor> renderPassDesc = NS::TransferPtr(MTL::RenderPassDescriptor::alloc()->init());
    ...
    {
        uint32_t layerIndex = cmd.subresourceRange.baseArrayLayer + layerOffset;
