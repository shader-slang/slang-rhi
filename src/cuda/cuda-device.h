...
{
public:
    virtual bool canCompileEntryPointsOnTaskPool() const override
    {
        // Slang's NVRTC downstream compiler mutates shared include-path caches without synchronization.
        return false;
    }
