...
SLANG_RHI_DEBUG_GET_INTERFACE_IMPL(RenderPipeline)
SLANG_RHI_DEBUG_GET_INTERFACE_IMPL(ComputePipeline)
SLANG_RHI_DEBUG_GET_INTERFACE_IMPL(RayTracingPipeline)
SLANG_RHI_DEBUG_GET_INTERFACE_IMPL(ResourceView)
SLANG_RHI_DEBUG_GET_INTERFACE_IMPL(Sampler)
