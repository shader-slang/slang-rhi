...
Result DebugDevice::reportHeaps(uint32_t* outHeapCount, IHeap::Report* outHeapReports, uint32_t bufferSize)
{
    SLANG_RHI_API_FUNC;

    return baseObject->reportHeaps(outHeapCount, outHeapReports, bufferSize);
}
