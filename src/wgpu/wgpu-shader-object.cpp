...
Result ShaderObjectImpl::createBindGroups(BindingContext& context) const
{
...
) const
{
    ...
    {
        BindingOffset offset = inOffset;
        SLANG_RETURN_ON_FAIL(bindOrdinaryDataBufferIfNeeded(context, /*inout*/ offset, layout));
    }
    ...
    // Bind the remaining resource parameters.
    {
        ...
        SLANG_RETURN_ON_FAIL(bindAsValue(context, offset1, layout));
    }
    return SLANG_OK;
}
