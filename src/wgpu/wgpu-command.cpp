...
Result CommandEncoderImpl::getBindingData(RootShaderObject* rootObject, BindingData*& outBindingData)
{
    ...
    builder.device = m_device;
    builder.commandList = m_commandList;
    builder.constantBufferPool = &m_commandBuffer->m_constantBufferPool;
    builder.allocator = &m_commandBuffer->m_allocator;
    builder.bindingCache = &m_commandBuffer->m_bindingCache;
