...
public:
    ...
    Result setPipelineWithRootObjectImpl(PipelineBase* pipeline, IShaderObject* rootObject);

    Result bindRenderState(VkPipelineBindPoint pipelineBindPoint, VkPipeline pipeline);
};
