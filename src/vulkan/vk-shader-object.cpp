...
)
{
    ...
    if (m_data.getCount())
    {
        ...
        context.writePushConstants(pushConstantRange, pushConstantData);
    }
...
Result RootShaderObjectImpl::bindAsRoot(RootBindingContext& context, RootShaderObjectLayout* layout)
{
