...
#define WEBGPU_SKIP_DECLARATIONS
#include <dawn/webgpu.h>

// clang-format off

#define SLANG_RHI_WEBGPU_PROCS(x) \
...
#define WEBGPU_DECLARE_PROC(name) WebGPUProc##name webgpu##name;
    SLANG_RHI_WEBGPU_PROCS(WEBGPU_DECLARE_PROC)
#undef WEBGPU_DECLARE_PROC
};
