...
public:
    ...
    {
        std::vector<WebGPUBindGroupLayoutEntry> entries;
        int32_t space = -1;
        WebGPUBindGroupLayout bindGroupLayout = nullptr;
    };
...
public:
    ...
    WebGPUPipelineLayout m_pipelineLayout = nullptr;
    static_vector<WebGPUBindGroupLayout, kMaxDescriptorSets> m_bindGroupLayouts;
