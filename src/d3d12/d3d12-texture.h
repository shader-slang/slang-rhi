...
public:
    ...
    ankerl::unordered_dense::map<ViewKey, CPUDescriptorAllocation, ViewKeyHasher> m_rtvs;
    ankerl::unordered_dense::map<ViewKey, CPUDescriptorAllocation, ViewKeyHasher> m_dsvs;
