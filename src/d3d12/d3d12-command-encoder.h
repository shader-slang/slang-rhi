...
public:
    ...
    Result bindPipelineImpl(PipelineBase* pipeline, IShaderObject** outRootObject);

    Result bindPipelineWithRootObjectImpl(PipelineBase* pipeline, IShaderObject* rootObject);
