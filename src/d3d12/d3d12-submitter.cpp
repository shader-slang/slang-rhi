...
void Submitter::uploadData(BufferImpl* buffer, size_t offset, size_t size, void const* data)
{
    uploadBufferDataImpl(m_device, m_commandList, m_transientHeap, buffer, offset, size, data);
}
