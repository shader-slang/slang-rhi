    ...
    if (buildInputs.geometryDescs)
    {
        ...
        for (Index i = 0; i < geomDescs.size(); i++)
        {
            ...
            case IAccelerationStructure::GeometryType::Triangles:
                ...
                geomDescs[i].Triangles.IndexFormat = D3DUtil::getMapFormat(inputGeomDesc.content.triangles.indexFormat);
                geomDescs[i].Triangles.Transform3x4 = inputGeomDesc.content.triangles.transform3x4;
                geomDescs[i].Triangles.VertexBuffer.StartAddress = inputGeomDesc.content.triangles.vertexData;
                geomDescs[i].Triangles.VertexBuffer.StrideInBytes = inputGeomDesc.content.triangles.vertexStride;
            ...
            case IAccelerationStructure::GeometryType::ProcedurePrimitives:
                ...
                geomDescs[i].AABBs.AABBs.StrideInBytes = inputGeomDesc.content.proceduralAABBs.stride;
                break;
            default:
