...
// Enable dumping of intermediate shader code generated by Slang compiler.
inline constexpr bool DUMP_INTERMEDIATES = false;
...
)
{
    ...
    if (deviceType == DeviceType::CUDA)
    {
        ...
        optixSearchPath.value.stringValue1 = "-I" SLANG_RHI_OPTIX_DEVICE_HEADER_INCLUDE_DIR
                                             "/"
                                             "9_0";
    ...
    {
        slang::CompilerOptionEntry dumpIntermediates;
        dumpIntermediates.name = slang::CompilerOptionName::DumpIntermediates;
        dumpIntermediates.value.kind = slang::CompilerOptionValueKind::Int;
        dumpIntermediates.value.intValue0 = 1;
        compilerOptions.push_back(dumpIntermediates);
    }
