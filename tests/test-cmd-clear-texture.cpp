...
GPU_TEST_CASE("cmd-clear-texture-depth-stencil", D3D11 | D3D12 | Vulkan | Metal | CUDA)
{
    TextureTestOptions options(device, 1);
    options
        .addVariants(TTShape::D2, TTArray::Both, TTMip::Both, TTMS::Off, kDepthStencilFormats, TextureUsage::DepthStencil);
