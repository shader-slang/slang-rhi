...
GPU_TEST_CASE("cmd-copy-texture-to-buffer-full", D3D12 | Vulkan | Metal | WebGPU | CUDA)
{
...
GPU_TEST_CASE("cmd-copy-texture-to-buffer-rowalignment", D3D12 | Vulkan | Metal | WebGPU | CUDA)
{
    TextureTestOptions options(device);
    options.addVariants(
        TTShape::All,     // all shapes
...
GPU_TEST_CASE("cmd-copy-texture-to-buffer-offset", D3D12 | Vulkan | Metal | WebGPU | CUDA)
{
    TextureTestOptions options(device);
    options.addVariants(
        TTShape::All,     // all shapes
...
GPU_TEST_CASE("cmd-copy-texture-to-buffer-sizeoffset", D3D12 | Vulkan | Metal | WebGPU | CUDA)
{
    TextureTestOptions options(device);
    options.addVariants(
        TTShape::All,     // all shapes
...
GPU_TEST_CASE("cmd-copy-texture-to-buffer-offset-mip1", D3D12 | Vulkan | Metal | WebGPU | CUDA)
{
    TextureTestOptions options(device);
    options.addVariants(
        TTShape::All,        // all shapes
...
GPU_TEST_CASE("cmd-copy-texture-to-buffer-sizeoffset-mip1", D3D12 | Vulkan | Metal | WebGPU | CUDA)
{
    TextureTestOptions options(device);
    options.addVariants(
        TTShape::All,        // all shapes
