...
struct PipelineCacheTestRender : PipelineCacheTest
{
    ...
    void runTests() override { SKIP("Render pipeline cache test is not implemented yet."); }
};
...
{
    runGpuTests(runTest<PipelineCacheTestRender>, {DeviceType::D3D12, DeviceType::Vulkan});
}
